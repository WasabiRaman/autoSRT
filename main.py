...
if __name__ == '__main__':  # TODO 추후에 카카오톡으로 알림 받게 만들어드림
    ...
    target_date = '20231202'  # yyyymmdd 형태로 입력
    target_time = sorted(['05:00', '12:10', '12:40'])  # hh:mm 형태로 입력 (8시간 범위까지만 허용됨)
    ...
    def get_train() -> bool:
        ...
        for i in trains:
            string_train = str(i)
            if seat_type == SeatType.SPECIAL_ONLY or seat_type == SeatType.SPECIAL_FIRST:  # 특실 우선 및 특실만 일때
